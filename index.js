...
navLinks.addEventListener('click', function (e) {
    ...
    if (target && target.classList.contains('nav__link')) {
        ...
        } else if (id.startsWith('https://')) { // Cek apakah link adalah tautan eksternal
            window.open(id, '_blank'); // Buka di tab baru
        } else if (id) {
            e.preventDefault(); // Hanya panggil preventDefault jika id valid
